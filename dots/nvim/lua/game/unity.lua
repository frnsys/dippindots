-- C# -----------------------------------------
-- Cribbed from <https://github.com/neovim/nvim-lspconfig/blob/master/lsp/roslyn_ls.lua>
...
vim.lsp.config["cs"] = {
  cmd = {
      'dotnet',
      '/opt/roslyn/content/LanguageServer/linux-x64/Microsoft.CodeAnalysis.LanguageServer.dll',
